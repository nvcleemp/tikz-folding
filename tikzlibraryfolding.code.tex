...
% Copyright 2009 by Nico Van Cleemput
%
...
\tikzstyle{every face}=[]
\tikzstyle{every triangle}=[]
\tikzstyle{every quadrangle}=[]
\tikzstyle{every pentagon}=[]
\tikzstyle{every hexagon}=[]
\tikzstyle{every octagon}=[]
\tikzstyle{every decagon}=[]

\def\tikz@lib@fold@triangle#1#2#3#4{%
  \path[every face, every triangle] (0,0) -- (\tikz@lib@fold@length,0) -- (60:\tikz@lib@fold@length) -- (0,0) -- cycle;
...
\def\tikz@lib@fold@square#1#2#3#4#5{%
  \path[every face, every quadrangle] (0,0) -- (\tikz@lib@fold@length,0) -- (\tikz@lib@fold@length,\tikz@lib@fold@length) -- (0,\tikz@lib@fold@length) -- (0,0) -- cycle;
...
\def\tikz@lib@fold@pentagon#1#2#3#4#5#6{%
  \path[every face, every pentagon] (0,0) -- (\tikz@lib@fold@length,0) -- ++(72:\tikz@lib@fold@length) -- ++(144:\tikz@lib@fold@length) -- (108:\tikz@lib@fold@length) -- (0,0) -- cycle;
...
\def\tikz@lib@fold@hexagon#1#2#3#4#5#6#7{%
  \path[every face, every hexagon] (0,0) -- (\tikz@lib@fold@length,0) -- ++(60:\tikz@lib@fold@length) -- ++(120:\tikz@lib@fold@length) -- ++(180:\tikz@lib@fold@length) -- ++(240:\tikz@lib@fold@length) -- ++(300:\tikz@lib@fold@length) -- (0,0) -- cycle;
  \begin{scope}
...
\def\tikz@lib@fold@octagon#1#2#3#4#5#6#7#8#9{%
  \path[every face, every octagon] (0,0) -- (\tikz@lib@fold@length,0) -- ++(45:\tikz@lib@fold@length) -- ++(90:\tikz@lib@fold@length) -- ++(135:\tikz@lib@fold@length) -- ++(180:\tikz@lib@fold@length) -- ++(225:\tikz@lib@fold@length) -- ++(270:\tikz@lib@fold@length) -- (0,0) -- cycle;
...
\def\tikz@lib@fold@decagon#1#2#3#4#5#6#7{%
  \path[every face, every decagon] (0,0) -- (\tikz@lib@fold@length,0) -- ++(36:\tikz@lib@fold@length) -- ++(72:\tikz@lib@fold@length) -- ++(108:\tikz@lib@fold@length) -- ++(144:\tikz@lib@fold@length) -- ++(180:\tikz@lib@fold@length) -- ++(216:\tikz@lib@fold@length) -- ++(252:\tikz@lib@fold@length) -- ++(288:\tikz@lib@fold@length) -- (0,0) -- cycle;
...
\def\tikz@lib@fold@rhombus#1#2#3#4#5#6{%
  \path[every face, every quadrangle] (0,0) -- (\tikz@lib@fold@length,0) -- ++(#1:\tikz@lib@fold@length) -- ++(180:\tikz@lib@fold@length) -- (0,0) -- cycle;
  \begin{scope}[xshift=.5\tikz@lib@fold@length,
  				shift={(#1:.5\tikz@lib@fold@length)}]
    #2
  \end{scope}
  \begin{scope}[shift={(#1:\tikz@lib@fold@length)}]
    #3
  \end{scope}
  \begin{scope}[xshift=\tikz@lib@fold@length,shift={(#1:\tikz@lib@fold@length)},rotate=-180+#1]
    #4
  \end{scope}
  \begin{scope}[xshift=\tikz@lib@fold@length,rotate=180]
    #5
